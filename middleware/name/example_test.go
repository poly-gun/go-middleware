...
func Example() {
	...
	middleware.Add(name.New().Settings(func(o *name.Options) { o.Name = "Example-Server-Name" }).Handler)
	...
	// Output: {"server-name":"Example-Server-Name"}
}
